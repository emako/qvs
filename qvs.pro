...
SOURCES += tools/single_image_video.cpp
SOURCES += preview/preview_dialog.cpp
SOURCES += preview/preview_image_dialog.cpp
...
SOURCES += mediainfo/mediainfo_id3.cpp
...
HEADERS += tools/single_image_video.h
HEADERS += preview/preview_dialog.h
HEADERS += preview/preview_image_dialog.h
...
HEADERS += preview/audio_info.hpp
...
HEADERS += mediainfo/mediainfo_id3.h
...
FORMS += tools/single_image_video.ui
FORMS += preview/preview_dialog.ui
FORMS += preview/preview_image_dialog.ui
