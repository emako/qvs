...
public:
    ...
    enum ECONFIG_COMMON {
        ...
        eCONFIG_COMMON_ADD_JOB_IMMEDIATELY,
        ...
        eCONFIG_COMMON_PREVIEW_SOUND_VALUME,
        eCONFIG_COMMON_PREVIEW_SOUND_IS_MUTE,
        eCONFIG_COMMON_ENCODING_AUDIO_CURRENT_PRESETS,
        eCONFIG_COMMON_MAX,
    };
